...
func EncryptNoErr(id int64) (cipherStr string) {
...
func Encrypt(plainText string, keyText string) (cipherStr string, err error) {
	...
	cfb := cipher.NewCFBEncrypter(c, commonIV) // 必须位16字节的参数因为AES默认block长度为16
...
func DecryptNotErr(cipherStr string) (plainText int64) {
