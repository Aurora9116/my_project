...
type MemberRepo interface {
	GetMemberByEmail(c context.Context, email string) (bool, error)
	GetMemberByAccount(c context.Context, account string) (bool, error)
	GetMemberByMobile(c context.Context, mobile string) (bool, error)
