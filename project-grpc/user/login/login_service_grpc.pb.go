...
func (c *loginServiceClient) Register(ctx context.Context, in *RegisterMessage, opts ...grpc.CallOption) (*RegisterRequest, error) {
...
func (UnimplementedLoginServiceServer) Register(context.Context, *RegisterMessage) (*RegisterRequest, error) {
